package com.example.lab7dialogrv_sec2_603021380_3
...
class MainActivity : AppCompatActivity() {
    ...
    fun addStudent(v: View) {
        ...
        mDialogView.btnAdd.setOnClickListener{
            studentList.add(
                Student(mDialogView.edt_ID.text.toString(), mDialogView.edt_name.text.toString(),
    ...
    fun testStudentData() {
        studentList.add(Student("60000002-1", "Alice",  20))
        studentList.add(Student("60000002-2", "Bob", 21))
    }
}